...
path_data='/storage/groups/ml01/workspace/karin.hrovatin/data/pancreas/scRNA/P21002/rev7/scanpy_AnnData/MUC2*/'
...
# %% [markdown]
# NOTE: Not really needed to do this longer ambient list.
...
# var_ref=h.open_h5ad(file='/storage/groups/ml01/workspace/karin.hrovatin/data/pancreas/scRNA/ref_combined/preprocessed/data_normalised.h5ad',
